...
```{r}
fviz_silhouette(fanny(sc,k=5,memb.exp = 1.1))
```

```{r}
fviz_silhouette(fanny(sc,k=5,memb.exp = 1.2))
```

```{r}
fviz_silhouette(fanny(sc,k=5,memb.exp = 1.3))
```

```{r}
fviz_silhouette(fanny(sc,k=5,memb.exp = 1.4))
```

```{r}
fviz_silhouette(fanny(sc,k=5,memb.exp = 1.5))
```

```{r}
fviz_silhouette(fanny(sc,k=5,memb.exp = 1.6))
```

```{r}
fviz_silhouette(fanny(sc,k=5,memb.exp = 1.7))
```

```{r}
fviz_silhouette(fanny(sc,k=5,memb.exp = 1.8))
```

```{r}
fviz_silhouette(fanny(sc,k=5,memb.exp = 1.9))
```

```{r}
fviz_silhouette(fanny(sc,k=5,memb.exp = 2.0))
```
